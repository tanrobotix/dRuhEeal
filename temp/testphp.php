...
<body>
  ...
  <div class=" tan-display-container tan-opacity-min" id="home">
    <div class=" tan-display-middle" style="white-space:nowrap;">
     ...
     <input class="searchbox" type="text" placeholder="Search" name="arr_search" >
     <button action="#" class="sb-buton tan-button tan-black" type="submit" name = "s_butt">SEARCH</button>
      </div>
  </div>
  </div>
...
<div class="row2" style="margin-left: 300px">  
  <div class="col-sm-6 col-md-3">
    <div class="thumbnail">
      <img src="img/data/agi1.jpg" alt="be">
      <div class="caption">
        <h3>th<?php echo $output; ?></h3>
        <p>...</p>
